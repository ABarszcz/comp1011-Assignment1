...
public class Utils {
	...
	department, position, employeeID, socialSecurityNum, salaryType, yearOfBirth,
	...
	department, position, employeeID, socialSecurityNum, yearOfBirth,
	...
	return new Product(name, productID, price, discount, mfact);
    }
	...
	return new Manufacturer(name, address, phoneNum, mfactID);
    }
