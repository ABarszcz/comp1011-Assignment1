...
public class SalaryEmployee extends Employee {
    ...
    public SalaryEmployee(String firstName, String lastName, String sex,
	    ...
	    String employeeID, String socialSecurityNum, String salaryType,
	    int yearOfBirth, int monthOfBirth, int dayOfBirth, BigDecimal salaryAmount) {
        super(firstName, lastName, sex, address, phoneNum, department, position,
		employeeID, socialSecurityNum, yearOfBirth, monthOfBirth, dayOfBirth);
